...
<html lang="en">
  ...
  <body>
    <div class="container">
      ...
      <div class="content">
        ...
        <div class="dropdown">
          ...
          <ul class="menu">
            <li onclick="window.location.href='#'">Change Preset</li>
            <li onclick="window.location.href='customize.php'">Add New Preset</li>
          </ul>
        </div>
        <div class="dropdown">
          <div class="select">
	...
	<div class="dropdown">
	  ...
	  <ul class="menu">
		<li onclick="window.location.href='growthStats.php'">Add Measurements</li>
	  </ul>
	</div>
        <button>About</button>
